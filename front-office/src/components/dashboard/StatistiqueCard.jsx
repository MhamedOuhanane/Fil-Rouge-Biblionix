export const StatistiqueCard = ({ title, icon, rating }) => {
    return (
        ...
        <div className="bg-gradient-to-r from-[#ff984484] via-orange-200 to-[#FCE3C9] p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
